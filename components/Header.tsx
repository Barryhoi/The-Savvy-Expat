...
export default function Header() {
  ...
  // forces the browser to re-blur everything scrolling behind it every frame,
  // which was the primary cause of scroll stutter on the pages that carry this
  // nav (home, /newsletter, /reviews). The page base is this exact colour, so a
  // solid fill looks the same without the per-frame cost.
  return (
